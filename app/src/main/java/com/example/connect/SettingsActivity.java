...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateProfileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(setUserName) || TextUtils.isEmpty(setAbout)){
                    Toast.makeText(SettingsActivity.this,"Please fill both of the above fields",Toast.LENGTH_LONG).show();
                }else{
        ...
        usersRef.child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    settingsNameEditText.setText(name);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        settingsNameEditText.setText("");
        settingsAboutEditText.setText("");
    }
    ...
    private void InitializeFields() {
        ...
        settingsNameEditText = findViewById(R.id.settings_name_edit_text);
